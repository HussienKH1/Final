    ...
    <section class="home">
        <div class ="max-width">
            <div class="hom-content">
                ...
                <a href="<?php echo e(route ('plan')); ?>" class="btn">Get started</a>
            </div>
       ...
       <h1 class="heading">Trainers</h1>
        <div class="card-wrapper">
            <div class="card">
                ...
                <a href="<?php echo e(route ('contact' )); ?>" class="btn">Contact</a>
        ...
        <div class="box-container">
            <div class="box">
                ...
                <div class="info">
                    ...
                    <a href="<?php echo e(route('article')); ?>">Read this article</a>
                </div>
            </div>
            <div class="box">
...
</html><?php /**PATH C:\Users\user\Desktop\Final\Gym\resources\views/index.blade.php ENDPATH**/ ?>