            ...
            <form action="<?php echo e(route ('signup.store')); ?>" method="POST">
             <?php echo csrf_field(); ?>   
                ...
                <div class="login-register">
                    <p>Already have an account?<a href="<?php echo e(route('auth.login')); ?>" class="login-link">Click Here</a></p>
                </div>
            </form>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\user\Desktop\Final\Gym\resources\views/auth/register.blade.php ENDPATH**/ ?>